<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AttendanceWebUserControl.ascx.cs"
    Inherits="TopCareWebApplication.UserControls.AttendanceWebUserControl" %>
...
<asp:MultiView ID="MultiView1" runat="server">
    <asp:View ID="View1" runat="server">
        <asp:LinkButton ID="btnEnterPayment" runat="server" 
            onclick="btnEnterPayment_Click">Enter Payment</asp:LinkButton>
    </asp:View>
            ...
            <tr>
                ...
                <td class="style5">
                    ...
                    <asp:FilteredTextBoxExtender ID="TextBox2_FilteredTextBoxExtender" 
                        runat="server" Enabled="True" TargetControlID="TextBox2" FilterType="Numbers, Custom"
    ValidChars=".">
