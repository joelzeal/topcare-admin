<%@ Page Title="" Language="C#" MasterPageFile="~/topcare/Site.Master" AutoEventWireup="true"
    CodeBehind="ScheAttendanceDetailedRpt.aspx.cs" Inherits="TopCareWebApplication.ReportPages.ScheAttendanceDetailedRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>
                    Schedule Detailed Report Type 1<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
